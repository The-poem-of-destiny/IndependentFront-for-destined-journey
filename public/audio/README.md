...
这批音频来自 SillyTavern 角色卡社群分发的 catbox 直链（原始清单见项目历史），**没有随附任何可核验的
授权凭据**。因此 manifest 里所有条目的 `license` 一律写作 `UNVERIFIED`，`credit` 如实标注来源不明——
**不要**把它们当成已授权素材对外分发。

本仓库受 `《命定之诗》内容二创与素材使用授权协议.md` 约束——该协议管的是世界观内容的二创，
**并不构成任何第三方音频素材的授权来源**。日后若要正式随应用分发，每首都需要一份独立、可核验的
