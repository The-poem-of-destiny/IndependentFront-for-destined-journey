...
- Modify: `docs/archive/planning/combat-v3-fix-backlog.md`（标 ✅）
- Test: 全量测试
...
在 `docs/archive/planning/combat-v3-fix-backlog.md` 把最后一项 `🟡 前端 ItemsPanel 缺 modifiers 展示` 标 ✅，并注明实现落点。

- [ ] **Step 4: Commit**

```bash
git add docs/archive/planning/combat-v3-fix-backlog.md
