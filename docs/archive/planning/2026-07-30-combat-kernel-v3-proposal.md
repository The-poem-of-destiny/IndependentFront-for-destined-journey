...
当前这些断点已经在[战斗系统审查报告](./2026-07-30-combat-event-system-review.md)中得到端到端验证喵
...
我不建议继续往当前 19-event pipeline 上打补丁，因为现有[审查报告](./2026-07-30-combat-event-system-review.md)已经证明核心 runner、pipeline、脚本注册和状态回写没有形成一条权威路径喵
