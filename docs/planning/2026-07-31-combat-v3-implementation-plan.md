...
> 🔗 **其他上游**：[v2 架构](../reference/combat-system-architecture.md) · [v2 审查报告](./2026-07-30-combat-event-system-review.md)（7 Critical + 15 Major） · [压测 RFC](./2026-07-31-combat-v3-real-sample-stress-test-rfc.md) · [5 场脑测案例集](./2026-07-31-combat-v3-stress-test/) · [数据字段规范](../superpowers/specs/2026-07-16-data-field-conventions-design.md) · [仓库治理](./2026-07-31-repo-management.md)
...
按 [`docs/planning/2026-07-31-repo-management.md`](./2026-07-31-repo-management.md)。补充约定：
...
**验收方式**：按 [`reference/agent流程测试/agent预期分析.md`](../../reference/agent流程测试/agent预期分析.md) 的流程走查——为 `combat_v3` / 改后的 `item_gen` / `char_gen` 各补一段「完整输出追踪（思维链 → 工具调用序列 → XML/JSON）+ 下游解析链路」，并在 M3.5 的 PR 内同步更新该文档。
...
| `docs/planning/2026-07-31-combat-v3-architecture-handoff.md` | 收尾：§2「待补完」表全部标 ✅ 并指向架构文档节号；顶部加「本地图已完成历史使命，架构见 ⑥」                                                                                                      |
| `docs/reference/combat-agent-api.md`                         | 按 §4.4 的 v3 工具集重写（或标注「v2 专用，已退役」）                                                                                                                                           |
...
> 来源：[`docs/planning/2026-07-30-combat-event-system-review.md`](./2026-07-30-combat-event-system-review.md)。「消解」= v3 架构使该问题不再存在（而非逐条修补）。
