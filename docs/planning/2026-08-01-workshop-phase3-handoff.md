...
| 设计真源     | `docs/planning/2026-08-01-workshop-social-design.md`（D18–D25 + 上游契约附录 + 优化 O1–O6）——**改任何社交代码前必读**                                  |
...
1. `docs/planning/2026-08-01-workshop-social-design.md` — 设计 + 契约 + 决策
