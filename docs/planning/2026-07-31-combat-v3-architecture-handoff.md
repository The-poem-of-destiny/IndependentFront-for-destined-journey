...
>
> 🔗 配套：[压测+补丁 RFC](./2026-07-31-combat-v3-real-sample-stress-test-rfc.md) · [5 场脑测案例集](./2026-07-31-combat-v3-stress-test/)
...
| ② | [`docs/planning/2026-07-30-combat-event-system-review.md`](./2026-07-30-combat-event-system-review.md) | **v2 对抗式审查报告** | 7 Critical / 15 Major / 9 Minor —— v3 要解决的 v2 断点清单 |
| ③ | [`docs/planning/2026-07-30-combat-kernel-v3-proposal.md`](./2026-07-30-combat-kernel-v3-proposal.md) + [`reference/战斗架构设计参考.txt`](../../reference/战斗架构设计参考.txt) | **v3 提案骨架**（Codex 原作） | dispatch 单入口 / EffectIntent 词汇 / 5 不变量 / 状态机 / 迁移映射表。**注意：骨架级，schema/window/RuleKey 内容留白** |
| ④ | [`docs/planning/2026-07-31-combat-v3-real-sample-stress-test-rfc.md`](./2026-07-31-combat-v3-real-sample-stress-test-rfc.md) | **本喵瞄压测+补丁 RFC** | 6 类缺口分析 + §5 补丁详案（5.1-5.7）+ §7 调整后 M0-M5 落地路线。**写 plan 的核心依据** |
| ⑤ | [`docs/planning/2026-07-31-combat-v3-stress-test/`](./2026-07-31-combat-v3-stress-test/) | **5 场脑测案例集** | 每场 EffectAutomaton 伪代码 / Command 序列 / 时间线 / 卡点。**写 plan 时验证覆盖度的实证库** |

⚠️ **重要**：③ 是骨架，**不是完整架构**。④ 的 §5 是对 ③ 的补丁。写 plan 前可能要先把 ③+④ 整合成一份正式《战斗架构 v3》文档（见 §3 待补完）。
