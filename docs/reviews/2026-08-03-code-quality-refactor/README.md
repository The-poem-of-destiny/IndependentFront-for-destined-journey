...
| [Q-25](findings-t5-layering.md#q-25) / [Q-24](findings-t5-layering.md#q-24) / [Q-20](findings-t6-safety-net.md#q-20) / [Q-21](findings-t3-single-source.md#q-21) | Q-25 等 Q-18 的类型落地；Q-24 与 Q-20 只是没排期（**不需要任何拍板**，Q-24 第一刀还是代码注释里预先授权过的）；Q-21 要配 audit-code 与世界书对账（涉平衡数值）—— 但见下方「Q-21 里藏着两处 live bug」                                                                                                                   |
