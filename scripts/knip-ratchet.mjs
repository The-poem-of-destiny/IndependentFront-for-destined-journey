 ...
 * - 捏人页那 4 个 Vue 组件当时算 Phase 7d **改造中**的在途件，删掉等于删同事没写完的活。
 *   （2026-08-17 更新：这 4 个文件 —— DestinyCoreCard / PartnerWorldBookPanel /
 *   FormCascader / FormKeyValue —— 已躺满两周无任何实质改动、全仓零引用，本轮清理已删除。
 *   要找回去 git 历史里捞，别再当在途件豁免。）
