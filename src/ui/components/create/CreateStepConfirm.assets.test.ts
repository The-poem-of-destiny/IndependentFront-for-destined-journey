...
function makeRow(name: string): AssetMetaRecord {
  return {
    id: 'asset_1', name, type: '头像',
    ext: 'png', mime: 'image/png', bytes: 12, createdAt: 1, updatedAt: 1,
  }
}
...
beforeEach(() => {
  ...
  mockCreate = {
    name: '苏婉',
    race: '人族', customRace: '',
    identity: '游侠', customIdentity: '',
    level: 1, tier: 1, tierName: '普通',
    startLocation: '翡翠之心',
    destinyCore: null,
    hpPreview: 10, mpPreview: 5, spPreview: 5,
    finalAttributes: { 力量: 1, 敏捷: 1, 体质: 1, 智力: 1, 精神: 1 },
    selectedEquipments: [], selectedSkills: [], selectedItems: [],
    selectedBackground: null, customBackgroundText: '',
    plotOutline: null,
    remainingPoints: 0,
  }
  mockAssets = {
