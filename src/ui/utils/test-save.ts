...
export async function createTestSave(options: { reset?: boolean } = {}): Promise<string> {
  ...
  const npcs: CharacterState[] = [
    createDefaultCharacterState({
      ...
      gender: '女',
      appearance:
        '银白长发如月光般垂至腰际，翠绿色的眼眸透着精灵族特有的灵气。五官精致而柔和，举手投足间带着千年寿命沉淀的优雅。',
      outfit:
        '一袭墨绿色的旅者长袍，袖口和领口绣有精灵族的藤蔓纹样。腰间系着一条深棕色皮革围裙，上面还沾着些许麦粉。',
      thoughts:
        '"最近商队失踪的事让人不安...卡尔的盗贼团越来越嚣张了。希望亚瑟能平安无事地查清真相。不过，那个蒙面人上周又来打听商队的事了，总觉得哪里不对劲..."',
      personality:
        '温柔善良，待客周到，是艾瑟嘉德最受欢迎的酒馆老板。偶尔会在打烊后独自对月抚琴，流露出不为人知的忧郁。能记住每一位常客的口味和故事。',
      background:
        '原是翡翠之心的精灵贵族之女，百年前因厌倦宫廷生活而离开故乡。辗转各地后定居艾瑟嘉德，开了这家"精灵之息"酒馆。虽表面与世无争，实则暗中帮助过许多冒险者。',
      customFields: {
    ...
    createDefaultCharacterState({
      ...
      thoughts:
        '"亚瑟...那个帝国走狗。他以为自己在伸张正义，殊不知那些商队运送的是帝国的军需物资。等我再劫一票，就有足够的钱雇更多人...到时候，艾瑟嘉德就是我的了。"',
      personality:
        '冷酷无情，行事果断。对敌人毫不留情，但对追随自己的手下却异常护短。极度憎恨地表精灵，认为他们背叛了暗精灵一族。有轻微的偏执倾向。',
      background:
        '曾是暗精灵地下城邦的影刃特工，因一次任务失败被流放。流落到地表后在近郊森林建立了盗贼团，专门劫掠奥古斯提姆帝国的商队。与翡翠之心的某些势力有秘密联系。',
      customFields: {
        // M6 T2: 双写退役 — 已升一等字段停写
        age: 95,
        role: 'enemy',
    ...
    createDefaultCharacterState({
      ...
      gender: '男',
      appearance:
        '满头银发整齐地束在脑后，深邃的蓝色眼眸仿佛能看透人心。虽然年过六旬，但面容依然硬朗，只是眼角和额头的皱纹记录着岁月的痕迹。右手的食指上有一枚镶嵌着蓝宝石的秘银戒指。',
      outfit:
        '深蓝色的法师长袍，袍面上绣着银色的星座图案，随着魔力波动微微闪烁。肩披一件暗红色的天鹅绒斗篷，斗篷内侧缝满了各种防护符文。手持一根古朴的橡木法杖，杖头嵌着一颗拳头大小的魔力水晶。',
      thoughts:
        '"草药的事不急，但那孩子的剑术还得再练练...帝国最近在边境集结兵力，不是什么好兆头。还有那个失踪的商队，我总觉得背后有更大的阴谋，不仅仅是盗贼团这么简单。也许我该找人调查一下近郊森林里的那个废弃神殿..."',
      personality:
        '睿智而风趣，喜欢用谜语和比喻来教导学生。对魔法研究有着近乎偏执的热情，为了找到一本古籍可以整整三天不眠不休。外表严肃但内心温暖，对年轻冒险者格外关照。',
      background:
        '奥古斯提姆帝国的前任宫廷首席法师，因不满帝国日益扩张的军国主义政策而辞官隐居。现居于翡翠之心的林歌城，偶尔接受冒险者公会的委托，为有潜力的年轻冒险者提供指导。暗中在研究和对抗一个古老的预言。',
      customFields: {
        // M6 T2: 双写退役 — 已升一等字段停写
        age: 62,
        role: 'mentor',
  ...
  const plotEvent: PlotEvent = {
    ...
    title: '商队失踪事件',
    description:
      '一队商人在艾瑟嘉德附近的森林中失踪。帝国派遣调查队，冒险者公会的悬赏吸引了各方势力。',
    status: 'active',
    childrenIds: [],
    order: 1,
  ...
  const memory: MemoryRecord = {
    ...
    content:
      '亚瑟在艾瑟嘉德的酒馆"精灵之息"中听说了商队失踪的消息。酒馆老板艾莉丝告诉他，最近已经有三个商队在近郊森林中失踪。冒险者公会的悬赏令贴在墙上，赏金不菲。一位神秘的蒙面人也曾在酒馆中打听商队的消息，似乎有着不为人知的目的。',
