...
function makeCharGenOutput(): CharGenOutput {
  return {
    ...
    background:
      '艾琳出身于极北冰原的霜语氏族，自幼便能听见寒风中传来的古老低语。她在十二岁那年独自穿越冰龙谷，与一头垂死的远古霜龙签订了灵魂契约，获得了操控冰元素的力量。从此她背负着龙族的遗愿，在冰原上巡行，寻找能够终结永恒寒冬的预言之火。',
    appearance:
      '银白色的长发如瀑布般垂至腰际，发梢泛着淡蓝色的冰晶光泽。皮肤苍白如雪，眼角微挑的冰蓝色瞳孔中闪烁着古老的龙纹。左臂上蔓延着霜蓝色的纹身，那是与霜龙签订契约时留下的印记。身形纤细但线条流畅，指尖常年凝结着细小的冰霜。',
    clothing:
      '身着一袭冰蓝色的丝绸长袍，外罩一件用霜狼皮毛缝制的白色斗篷。腰间系着一条镶有月光石的符文腰带，每颗符文石都在微微发光。脚穿一双轻便的冰蜥皮靴，行走时几乎不会留下足迹。',
    personality:
      '冷静、内敛，话语间带着古老的优雅。对陌生人保持距离，但一旦建立信任便会展现出守护者般的温柔。偶尔会在不经意间流露出龙族血脉带来的傲慢与孤寂。喜爱在雪中独行，习惯用诗歌记录所见所闻。',
    ...
    skills: [
      ...
      },
      {
        name: '寒冰护体',
        description:
          '被动凝聚周围寒气形成护盾，受到攻击时减免 20% 伤害，并对攻击者造成轻微冰霜反弹。',
        type: 'passive',
      },
    ],
    equipment: [
    ...
    skills: [
      {
        name: '极光闪现',
        description:
          '化作一道极光瞬间移动到 20 米内的任意可见位置，并在原位置留下一片持续 2 回合的冰霜薄雾区域，踏入的敌人移动速度降低 30%。',
        type: 'active',
    ...
    inventory: [
      {
        name: '远古魔力水晶',
        description:
          '蕴含庞大魔力的紫色水晶，据说是上古魔法帝国的能源核心碎片。可以用来强化装备或作为高级炼金材料。',
        quantity: 1,
        type: '材料',
        rarity: '史诗',
      },
      {
        name: '冰龙鳞片',
        description: '从远古霜龙身上脱落的完整鳞片，具有极强的冰元素亲和力和物理防御力。',
        quantity: 3,
        type: '材料',
        rarity: '传说',
      },
      {
        name: '冒险者口粮套装',
        description: '包含干肉、奶酪、硬面包和一小壶葡萄酒的标准旅行补给包。',
        quantity: 5,
        type: '消耗品',
        rarity: '普通',
      },
